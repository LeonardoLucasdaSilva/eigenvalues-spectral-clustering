import numpy as np
from algorithms.qr_iteration import qr_iteration_householder_shift_deflation, qr_iteration_householder_shift
...
for k in range(n):
    ...
    H,Q = qr_iteration_householder_shift_deflation(L_sym, tol = 1e-8)
