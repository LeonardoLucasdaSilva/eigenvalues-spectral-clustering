import numpy as np
from algorithms.qr_iteration import qr_iteration_householder_shift
...
print("QR iteration with shift for L_rw matrix:")
for k in range(n):
    start = time.time()

    H, Q = qr_iteration_householder_shift(L_rw, tol = 5e-8)
...
relative_error(r1, r2, title="Shift QR")